...
// Create a function that gets the name of the piece of jewelry with the highest 
// price and returns "The most expensive one is the {name of jewelry piece}".
...
function mostExpensive(obj) {
  ...
  for (const key in obj) {
    if (obj[key] > highestPrice) (mostExpensiveJewelry = key, highestPrice = obj[key]);
  }
